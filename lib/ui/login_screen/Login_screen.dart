...
import 'package:quizgames/ui/Register_screen/Register_screen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  @override
  void initState() {
    bloc..add(RegisterServicesEvent());
    super.initState();
  }
            ...
            if (state is LoginInitial) {
              ...
              return Container(
                ...
                child: Column(
                  ...
                  children: [
                    Image.asset(
                      'assets/icons/icons8-loading-64.png',
                    ),
                  ],
                ),
              );
